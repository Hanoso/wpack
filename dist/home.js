...
module.exports = "htpp://localhost/7157911d86d7f260bb8c043ea18d3e61.png";
...
var A = loge(_class = (_temp = function A() {
...
console.log(window.$, 'jQuery'); // 打包图片
// 1）在js中创建图片来引入
...
var image = new Image();
console.log(image);
image.src = _2_png__WEBPACK_IMPORTED_MODULE_3___default.a;
document.body.appendChild(image); //2) 在css中引入图片
